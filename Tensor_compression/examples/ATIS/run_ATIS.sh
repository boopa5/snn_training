...
# python -u ./examples/ATIS/train_ATIS.py -save_model models/ATIS_tensor_2layers -batch_size 16 -use_cuda_graph 1 -max_length 32|tee logs/ATIS_tensor_2layers.txt
